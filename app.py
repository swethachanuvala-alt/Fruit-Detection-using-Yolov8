...
<style>
    ...
    /* Overall app background: vibrant multi-color mesh, like fruit-stall colors */
    .stApp {
        background:
            radial-gradient(circle at 15% 20%, rgba(255, 107, 107, 0.55) 0%, transparent 40%),
            radial-gradient(circle at 85% 15%, rgba(255, 183, 3, 0.55) 0%, transparent 42%),
            radial-gradient(circle at 20% 85%, rgba(76, 175, 80, 0.5) 0%, transparent 42%),
            radial-gradient(circle at 85% 88%, rgba(155, 93, 229, 0.45) 0%, transparent 42%),
            radial-gradient(circle at 50% 50%, rgba(255, 214, 102, 0.4) 0%, transparent 55%),
            linear-gradient(160deg, #fffaf0 0%, #fff3e0 100%);
    ...
    .hero h1 {
        ...
        background: linear-gradient(90deg, #ff5c5c, #ff9f1c, #ffd166, #06d6a0, #4d96ff, #c77dff, #ff5c5c);
    ...
    .metric-pill:nth-child(1) { background: linear-gradient(135deg, #ff6b6b, #ff9f43); }
    .metric-pill:nth-child(2) { background: linear-gradient(135deg, #ffd166, #ff9f1c); }
    .metric-pill:nth-child(3) { background: linear-gradient(135deg, #06d6a0, #37b881); }
    .metric-pill:nth-child(4) { background: linear-gradient(135deg, #4d96ff, #7c6bff); }
    .metric-pill .num {
        font-size: 1.7rem;
        font-weight: 800;
    }
    ...
    .chip .conf {
        font-weight: 700;
        color: white;
        background: linear-gradient(135deg, #06d6a0, #37b881);
    ...
    section[data-testid="stSidebar"] {
        background: linear-gradient(180deg, #ffe8d6 0%, #ffd6e8 45%, #d6f5e8 100%);
    }
